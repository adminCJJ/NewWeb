...
<html>
	...
	<header class="navbar navbar-fixed-top" >
		...
		<div class="pull-right header-btns">
			...
			<a href="login.jsp" class="btn btn-default btn-gradient" type="button"><span class="glyphicons glyphicon-log-out"></span> 退出</a>
		</div>
	</header>
	<!-- End: Header -->
	...
	<div id="main"> 
				...
				<ul class="nav sidebar-nav">
					...
					<li> 
						...
						<ul class="nav sub-nav" id="sideEight" style="">
							...
							<li>
								<a href="${pageContext.request.contextPath }/servlet/TypeServlet?op=query" target="iframe"><span class="glyphicons glyphicon-record"></span>新闻类型管理</a>
							</li>
						</ul>	
					</li>
		...
		<section id="content" >
			...
			<div class="col-md-9" style="height: 100%; padding: 0 0 0 0;">
				<iframe src="${pageContext.request.contextPath }/manage/welcome.jsp" scrolling="no" style="width: 110%; height:700px; padding: 0 0 0 0;" name="iframe" id="docs-content"></iframe>
			</div>
			</div> 
